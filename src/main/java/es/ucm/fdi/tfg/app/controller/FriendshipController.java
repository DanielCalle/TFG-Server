...
<<<<<<< HEAD
	...
	@PostMapping({ "", "/" })
	@ResponseBody
	public ResponseEntity<Friendship> save(@RequestBody Friendship friendship) {

		String requesterUuid = friendship.getRequester().getUuid();
		String friendUuid = friendship.getFriend().getUuid();

		// Find users for to see exist
		Optional<UserApp> optRequester = userRepository.findById(requesterUuid);
		Optional<UserApp> optFriend = userRepository.findById(friendUuid);
		...
		if (optRequester.isPresent() && optFriend.isPresent()) {
			...
			friendshipId1.setFriend(friendUuid);
			friendshipId1.setRequester(requesterUuid);
			friendshipId2.setFriend(requesterUuid);
			friendshipId2.setRequester(friendUuid);
	...
	@ResponseBody
	public ResponseEntity<Friendship> accept(@PathVariable String requesterUuid, @PathVariable String friendUuid) {
	...
	@ResponseBody
	public ResponseEntity<Friendship> delete(@PathVariable String requesterUuid, @PathVariable String friendUuid) {
		// Find the friendship
		FriendshipId friendshipId = new FriendshipId();
		friendshipId.setFriend(friendUuid);
		friendshipId.setRequester(requesterUuid);
	...
	@ResponseBody
	public ResponseEntity<Friendship> getUserById(@PathVariable String requesterUuid, @PathVariable String friendUuid) {
		FriendshipId friendshipId = new FriendshipId();
		friendshipId.setFriend(friendUuid);
		friendshipId.setRequester(requesterUuid);
		Optional<Friendship> friendship = friendshipRepository.findById(friendshipId);
...
>>>>>>> parent of 59e9cdf... changes to see if they are friends
}
